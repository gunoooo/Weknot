...
public class SocialFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        RecyclerView requestView = view.findViewById(R.id.recyclerViewRequestFriend);
        RecyclerView FriendView = view.findViewById(R.id.recyclerViewFriend);

        connetRecyclerView(requestView,false);
        connetRecyclerView(FriendView,true);

        return view;
    }

    private void connetRecyclerView(RecyclerView recyclerView, boolean type) {
